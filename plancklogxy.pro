set_plot, 'ps'
device, filename='plancktempwavLOGXY.ps'
...
cgplot,wav,b,/WINDOW, ASPECT =0.8,/ylog,/xlog,xtitle='wavelength (Angstrom)',ytitle='Planck function', $
  xmargin = [45,5],$
...
device,/close
filenmame='plancktempwavLOGXY.ps'
end